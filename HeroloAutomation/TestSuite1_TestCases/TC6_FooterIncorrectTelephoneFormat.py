...
class FooterIncorrectTelephoneFormat(unittest.TestCase):
    ...
    def test_insert_incorrect_telephone_format(self):
        ...
        try:
            ...
            self.driver.find_element_by_xpath("/html/body/div[1]/div[1]/div/footer/form/div/div[2]/label/span")
